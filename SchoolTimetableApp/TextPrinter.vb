Public Class TextPrinter
    ...
    Protected Overrides Sub OnPrintPage(ByVal ev _
       As Printing.PrintPageEventArgs)
        ...
        Dim rectPrintingArea As New RectangleF(intMarginLeft,
        ...
        ev.Graphics.MeasureString(Mid(strText,
                    UpgradeZeros(intCurrentChar)), Font,
                    New SizeF(intPrintAreaWidth,
                    intPrintAreaHeight), objSF,
                    intCharsFitted, intLinesFilled)
        ' Print the text to the page
        ev.Graphics.DrawString(Mid(strText,
            UpgradeZeros(intCurrentChar)), Font,
